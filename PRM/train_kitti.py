...
def main(args):
    ...
    if args.train:
        solver.train(train_loader, train_logger)
    if args.run_demo:
        # Load demo images and pre-computed object proposals
        # change the idx to test different samples
        idx = 13
        img_name = '/projectnb/saenkog/zlzhu/robotic_recycling/workplace/ultra-thin-PRM/data/sample%d.png' % idx
        # try:
        ...
        for i in range(raw_imgs.shape[0]):
            ...
            proposals=comprop.main(raw_img)
